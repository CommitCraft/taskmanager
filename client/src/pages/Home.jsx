...
function Hero() {
  ...
  return (
    <section id="home" className="pt-20 bg-gradient-to-b from-indigo-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">
            <span className="relative whitespace-nowrap text-blue-600">
              <span className="relative">Manage Tasks </span>
            </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <h3 className="text-xl font-semibold mb-4">Personal Task Management</h3>
            <p className="text-gray-600">
              Perfect for individuals looking to organize their daily tasks and boost productivity.
            </p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600">
              Comprehensive tools for teams to work together efficiently on projects.
            </p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-gray-600 mb-6">
              TaskFlow was born from the need for a more intuitive and efficient way to manage tasks 
              and collaborate with team members. Our platform combines powerful features with 
              simplicity, making task management accessible to everyone.
            </p>
            <p className="text-gray-600 mb-6">
              We're committed to continuous improvement and innovation, always listening to our users' 
              feedback to create the best possible task management experience.
            </p>
